...
class _AllJournalsState extends State<AllJournals> {
  ...
  void setProfileIcons(emoji) async {
    emoticon = emoji["image"] != "" ? emoji["image"] : "128218";
            ...
            child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: Text(
                      "CATEGORY : ${currentTag.toUpperCase()}",
                      style: const TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.bold,
                        color: Color.fromARGB(255, 43, 60, 80),
                      ),
                    ),
                  ),
                  FutureBuilder(
                        ...
                        if (snapshot.hasError) {
                          ...
                          return Column(
                              ...
                              children: [
                                snapshot.data == null
                                    ? const Center(
                                        child: Text("No journals to display"))
                                    : ListView.builder(
