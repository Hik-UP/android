...
class _AddPageState extends State<AddPage> {
  ...
  handleSubmit()async{
    if (titleController.text.isEmpty) {
      ...
      if(allJournals==null){
        ...
        fToast.init(context);
        showToast(fToast, "Notetest created successfully. Please refresh to view your newly created note", NotificationStatus.success);
        setState(() {
          isLoading=false;
        });
        ...
        fToast.init(context);
        showToast(fToast, "L'invitation a été envoyé.", NotificationStatus.success);
        Navigator.of(context).pop();
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 213, 240, 209),
      appBar: AppBar(
        title: const Text("Inviter une personne", style: TextStyle(color: Colors.black38),),
      ...
      FloatingActionButton.extended(
        ...
        backgroundColor: Color.fromARGB(255, 160, 239, 168),
        onPressed: (){
          setState(() {
            true;
          });
        ...
        tooltip: 'Add',
        label: Row(children: const [Icon(Icons.add),SizedBox(width: 5),Text("Envoyer")]),
      ),
      body: Container(
            ...
            Container(
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: Color.fromARGB(255, 196, 225, 195),
