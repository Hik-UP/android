...
class _AllChecklistState extends State<AllChecklist> {
  ...
  removeItem(int index) async {
    ...
    if(addChecklistController.text.isEmpty){
      fToast.init(context);
      showToast(fToast, "Cette section ne doit pas etre vide", NotificationStatus.success);
    } else{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 204, 240, 207),
      appBar: AppBar(
        title: const Text("Historique", style: TextStyle(color: Color.fromARGB(255, 93, 22, 22), fontWeight: FontWeight.bold)),
